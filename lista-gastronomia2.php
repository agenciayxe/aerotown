            ...
            <div class="box-loja">				
                ...
                <div class="box">
                	<ul>
						...
						if ($singleLojas->cardapio) {
            				?>
            				<li>
								<a href="/wp-content/themes/aerotown/img/gastronomia/cardapio/<?php echo $singleLojas->cardapio;?>" target="_blank">
									<i class="fa fa-download"></i> Baixar Cardápio
								</a>
            				</li>
