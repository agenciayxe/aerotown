<?php 
$results = $wpdb->get_results("SELECT * FROM ae_stores ORDER BY numero ASC ");
if ($results) {
		...
		<article class="loja col-md-3 col-xs-12">
            <div class="box-loja">
				<div style="text-align: center">					
					<img src="/wp-content/themes/aerotown/img/lojas/logos/<?php echo $singleLojas->img ?: 'blank.jpg'; ?>" style="width: 100%; margin-bottom: 10px"/>					
				</div>
            	<div class="titulo">
