...
<section class="banner-topo home-banner" style="padding: 0">
	<div class="">
		<div class="row">
			<div class="col-xs-12">
				<?php 
							...
							while ($querySlide->have_posts()) {
								...
								if (get_field('imagem')) {
									...
									<div class="swiper-slide">
										...
										?>
										<div class="banner-slide-single hidden-xs" style="background-image: url('<?php echo $imageCurrent['url']; ?>'); background-position: center; background-size: cover"></div>										
										<img class="visible-xs" src="<?php echo $imageCurrent['url']; ?>" />
										<?php 
...
<main class="home">
	...
	<section class="instagram">
		<div class="container">
			...
			<script src="https://cdn.lightwidget.com/widgets/lightwidget.js"></script><iframe src="//lightwidget.com/widgets/02d5d1f8c74d5d29b9efaeef1e933462.html" scrolling="no" allowtransparency="true" class="lightwidget-widget" style="width:100%;border:0;overflow:hidden;"></iframe>
		</div>
	</section>
	<section class="galeria bg-1">
		<div class="container">
			<div class="titulo">
				PRÓXIMOS<br>
				<span>EVENTOS</span>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<br> -->
				<img src="<?php bloginfo('template_url') ?>/img/popup-post-show.png" alt="">
			</div>
		</div>
	</div>
</div>
<div class="modal fade modal-destaque" id="destaque" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><i class="fa fa-close"></i></span></button>
			<div class="modal-body">
				<img src="<?php bloginfo('template_url') ?>/img/popup-covid-19.jpg" alt="">
			</div>
		</div>
	</div>
</div>
