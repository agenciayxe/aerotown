	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 my-3">
				...
				$wpdb->get_results( "SELECT *  FROM roleta_cadastros WHERE premio_id != 1 AND  premio_id != 4 AND  premio_id != 7 AND  premio_id != 11" );
				$quantidadeCadastros = $wpdb->num_rows;
			...
			<div class="col-md-12 my-3">
				...
				$listPremiados = $wpdb->get_results( "SELECT *  FROM roleta_cadastros WHERE premio_id != 1 AND  premio_id != 4 AND  premio_id != 7 AND  premio_id != 11" );
				?>
				<table class="table">
					<thead>
						<tr>
