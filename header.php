...
<head>
    ...
    <link href="<?php bloginfo('template_url') ?>/css/main.css?v=1.2.4" rel="stylesheet">
            ...
            <div class="row align-items-center">
                <div class="col-xs-12 visible-xs">
                    ...
                    <a href="<?php bloginfo('home'); ?>">
                        <img class="logo" src="<?php bloginfo('template_url') ?>/img/logo-aerotown.png" alt="Logo Aerotown">
                    </a>
                </div>
