...
<main class="lojas home-banner banner-page">
	...
	<section class="loja" style="margin: 50px 0">	
		<div class="container">
			<?php $loja = $wpdb->get_row("SELECT * FROM ae_stores WHERE id = {$_GET['loja']};"); ?>
			<?php 
				...
				<div class="col-xs-12 col-md-6">
					...
					<div class="home-banner banner-page">
						<div class="market-slide swiper-content">
							...
							<div class="swiper-wrapper">
								<div class="swiper-slide">		
									<div class="banner-slide-single" style="background-image: url('/wp-content/themes/aerotown/img/lojas/logos/<?php echo $loja->img ?: 'blank.jpg'; ?>'); min-height: 500px"></div>
								</div>
				...
				<div class="col-xs-12<?php if(isset($images)) echo " col-md-4"; ?>">
					...
					<ul class="list-unstyled">	
						...
						if ($loja->descricao) {
            				?>
            				<li>
								<a href="tel:+55<?php echo preg_replace("/[^0-9]/", "", $loja->descricao); ?>" target="_blank">
									<i class="fa fa-phone"></i> 
